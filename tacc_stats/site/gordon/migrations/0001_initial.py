    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Load_L1Hits', models.FloatField(null=True)),
                ('Load_L2Hits', models.FloatField(null=True)),
                ('Load_LLCHits', models.FloatField(null=True))
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='host',
            name='jobs',
            field=models.ManyToManyField(to='gordon.Job'),
