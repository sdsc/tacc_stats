...
from tacc_stats.site.gordon.models import Job
...
acct_jobs_list = Job.objects.filter(date__range = ["2015-05-01", "2015-06-30"]).exclude(exe = "unknown").exclude(status = "FAILED")
